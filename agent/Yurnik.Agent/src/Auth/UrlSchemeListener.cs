...
/// <summary>
/// Listens on a named pipe for yurnik:// URLs forwarded from a second agent instance.
///
/// When Windows routes yurnik://auth?token=... to the agent exe, it launches a new
...
{
    internal const string PipeName = "yurnik-agent-url";

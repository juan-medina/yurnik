...
const REPO_URL = "https://github.com/juan-medina/yurnik";
...
export default function Footer() {
  ...
  return (
    <footer className="flex flex-wrap items-center justify-center gap-3 border-t border-border px-4 py-2 text-xs text-muted-foreground/60">
      <a
        href={REPO_URL}
        target="_blank"

...
export const SESSIONS: Session[] = [
  {
    ...
    coverColor: "#3d2b1f", coverAccent: "#c9a84c", coverUrl: coverUrl("Elden Ring"),
  ...
  },
  {
    ...
    coverColor: "#1a1f3e", coverAccent: "#818cf8", coverUrl: coverUrl("Baldur's Gate 3"),
  ...
  },
  {
    ...
    coverColor: "#1c1c2e", coverAccent: "#94a3b8", coverUrl: coverUrl("Hollow Knight"),
  ...
  },
  {
    ...
    coverColor: "#0a0a12", coverAccent: "#eab308", coverUrl: coverUrl("Cyberpunk 2077"),
  ...
  },
  {
    ...
    coverColor: "#2d0a0a", coverAccent: "#f97316", coverUrl: coverUrl("Hades II"),
  ...
  },
  {
    ...
    coverColor: "#0f2a1e", coverAccent: "#22c55e", coverUrl: coverUrl("Dead Cells"),
  ...
  },
  {
    ...
    game: "Elden Ring", coverColor: "#3d2b1f", coverAccent: "#c9a84c", coverUrl: coverUrl("Elden Ring"),
    genres: ["RPG", "Soulslike", "Open World"],
  ...
  },
  {
    ...
    game: "Cyberpunk 2077", coverColor: "#0a0a12", coverAccent: "#eab308", coverUrl: coverUrl("Cyberpunk 2077"),
    genres: ["RPG", "Open World", "Sci-fi"],
  ...
  },
  {
    ...
    game: "Hollow Knight", coverColor: "#1c1c2e", coverAccent: "#94a3b8", coverUrl: coverUrl("Hollow Knight"),
    genres: ["Metroidvania", "Action", "Indie"],
  ...
  },
  {
    ...
    game: "Hades II", coverColor: "#2d0a0a", coverAccent: "#f97316", coverUrl: coverUrl("Hades II"),
    genres: ["Roguelite", "Action", "Indie"],
  ...
  },
  {
    id: "s12",
    player: { id: "o1", name: "Jordan Park", handle: "jordanp.bsky.social", color: "#0284c7" },
    game: "Dead Cells", coverColor: "#0f2a1e", coverAccent: "#22c55e", coverUrl: coverUrl("Dead Cells"),
    genres: ["Roguelike", "Action", "Platformer"],
...
export const GAME_LIBRARY: Game[] = [
  { id: "g1", game: "Elden Ring", coverColor: "#3d2b1f", coverAccent: "#c9a84c", coverUrl: "https://cdn.akamai.steamstatic.com/steam/apps/1245620/library_600x900.jpg", genres: ["RPG", "Soulslike", "Open World"] },
  { id: "g2", game: "Baldur's Gate 3", coverColor: "#1a1f3e", coverAccent: "#818cf8", coverUrl: "https://cdn.akamai.steamstatic.com/steam/apps/1086940/library_600x900.jpg", genres: ["RPG", "Strategy", "Co-op"] },
  { id: "g3", game: "Hollow Knight", coverColor: "#1c1c2e", coverAccent: "#94a3b8", coverUrl: "https://cdn.akamai.steamstatic.com/steam/apps/367520/library_600x900.jpg", genres: ["Metroidvania", "Action", "Indie"] },
  { id: "g4", game: "Cyberpunk 2077", coverColor: "#0a0a12", coverAccent: "#eab308", coverUrl: "https://cdn.akamai.steamstatic.com/steam/apps/1091500/library_600x900.jpg", genres: ["RPG", "Open World", "Sci-fi"] },
  { id: "g5", game: "Hades II", coverColor: "#2d0a0a", coverAccent: "#f97316", coverUrl: "https://cdn.akamai.steamstatic.com/steam/apps/1145360/library_600x900.jpg", genres: ["Roguelite", "Action", "Indie"] },
  { id: "g6", game: "Dead Cells", coverColor: "#0f2a1e", coverAccent: "#22c55e", coverUrl: "https://cdn.akamai.steamstatic.com/steam/apps/588650/library_600x900.jpg", genres: ["Roguelike", "Action", "Platformer"] },
  { id: "g7", game: "Dark Souls III", coverColor: "#1a1a1a", coverAccent: "#d4af37", coverUrl: "https://cdn.akamai.steamstatic.com/steam/apps/374320/library_600x900.jpg", genres: ["RPG", "Soulslike", "Action"] },
  { id: "g8", game: "Sekiro", coverColor: "#1a0a0a", coverAccent: "#dc2626", coverUrl: "https://cdn.akamai.steamstatic.com/steam/apps/814380/library_600x900.jpg", genres: ["Action", "Soulslike"] },
  { id: "g9", game: "Celeste", coverColor: "#0d0d2b", coverAccent: "#60a5fa", coverUrl: "https://cdn.akamai.steamstatic.com/steam/apps/504230/library_600x900.jpg", genres: ["Platformer", "Indie"] },
  { id: "g10", game: "Disco Elysium", coverColor: "#1e1b2e", coverAccent: "#a78bfa", coverUrl: "https://cdn.akamai.steamstatic.com/steam/apps/632470/library_600x900.jpg", genres: ["RPG", "Adventure", "Narrative"] },
  { id: "g11", game: "Persona 5 Royal", coverColor: "#1a0000", coverAccent: "#ef4444", coverUrl: "https://cdn.akamai.steamstatic.com/steam/apps/1687950/library_600x900.jpg", genres: ["RPG", "JRPG", "Turn-based"] },
  { id: "g12", game: "Monster Hunter: World", coverColor: "#0f1e0f", coverAccent: "#84cc16", coverUrl: "https://cdn.akamai.steamstatic.com/steam/apps/582010/library_600x900.jpg", genres: ["Action", "RPG", "Co-op"] },
];
...
export const MOCK_PENDING_SESSIONS: PendingSession[] = [
  ...
  {
    id: "ps3", game: "",
    coverColor: "#1a1a1a", coverAccent: "#6b7280",

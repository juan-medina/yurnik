...
-- Database
SELECT 'CREATE DATABASE yurnik_dev OWNER yurnik_admin'
WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'yurnik_dev')\gexec
...
GRANT CONNECT ON DATABASE yurnik_dev TO yurnik_api;
